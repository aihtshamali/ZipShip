...
<div class="container profile animate-left">
    ...
    @if(isset($order->user_id))
      <div class="marginauto border width70 padding1per">
          <img src="{{asset('uploads/userprofile/'.$order->user->dp)}}" class="circle" width="35px" />
          <b class="paddingLef1per"><span class="black capitalize">{{$order->user->firstname}} {{$order->user->lastname}}</span><span class="grayee"> requested</span><span class="right">{{$order->deliver_before}}</span></b>
          <div class="marginper fullwidth marginTopTen" style="min-height: 250px;">
              ...
              <div class="width68 right padding1per">
                  ...
                  <p class="backgrounpurpleopp padding3per borderRad7px">
                      <span class="grayee">Deliver to</span> <span class="black capitalie">{{$order->to_loc}} {{$order->to_city}} , {{$order->to_country}}</span>
                      <span class="grayee">From</span>
                      <span class="black">{{$order->from_loc}} {{$order->from_city}} , {{$order->from_country}}</span>
                  </p>
                   <b><span class="grayee">where to buy </span><span class="textpurple">{{$order->item_url}}</span></b>
                      <hr class="margin10px">
    ...
    <div id="myModal" class="modal">
      ...
      <div class="modal-content container width30">
        ...
        <form class="" method="POST" action="{{route('bids.store')}}">
          ...
          <div class="form-group">
              <span class="right"><input type="submit" name="bid" class="btn bg-colored white" value="Bid"></span>
          </div>
      </form>
      </div>
