...
<div class="profile animate-left" style="min-height: 500px;">
    <div class="container">
        ...
        <p class="menuOrders">
            <span id="requested"><a href="{{route('post.index')}}"><b>Requested</b><a></span>
            <span id="in_transite"><a href="{{route('post.index',['status'=>'intransite'])}}"><b>In Transite</b></a></span>
    ...
    <div class="clear container" >
      @foreach($orders as $order)
        <span style="">
          ...
          @if( $order->bids($order->id)[0]->bids_count > 0)
