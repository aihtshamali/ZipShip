...
<div class="container profile animate-left">
    ...
    <div class="marginauto border width70 padding1per">
        ...
        <b class="paddingLef1per"><span class="black">Name</span><span class="grayee"> requested</span><span class="right">{{$order->deliver_before}}</span></b>
        <div class="marginper fullwidth marginTopTen" style="min-height: 250px;">
            ...
            <div class="width68 right padding1per">
                ...
                <p class="backgrounpurpleopp padding3per borderRad7px">
                 ...
                 <b><spa class="grayee">where to buy </span><span class="textpurple">{{$order->item_url}}</span></b>
                    <hr class="margin10px">
